...
namespace Infrastructure.Data
{
    public static class StoreContextSeed
    {
        public static async Task SeedAsync(StoreContext context)
        {
            ...
            Category ls = new Category() { Name = "Lipsticks" };
            Category fo = new Category() { Name = "Foundations" };
            Category el = new Category() { Name = "Eyeliners" };
            Category ms = new Category() { Name = "Mascaras" };
            ...
            Product p4 = new Product() { Name = "Maybelline New York Lash Sensational Sky High Mascara", Price = 119.90m, PictureUri = "04.jpg", Brand = mn, Category = ms };
            ...
            Product p7 = new Product() { Name = "Mac Penultimate Eye Liner - Rapidblack", Price = 89.90m, PictureUri = "07.jpg", Brand = mc, Category = el };
